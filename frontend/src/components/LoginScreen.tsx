...
export default function LoginScreen() {
  ...
  return (
    <div className="flex flex-1 h-full overflow-hidden">
      ...
      <div className="hidden lg:flex flex-none w-1/2 h-full relative bg-layout-bg border-r border-outline-variant" style={{ backgroundColor: COLORS.background.dark, borderColor: COLORS.border.variant }}>
        {/* Animated SVG Map */}
        <div className="w-full h-full p-20 opacity-70">
          <svg style={{ background: COLORS.background.dark }} viewBox="0 0 800 1000" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            ...
            <circle cx="420" cy="350" fill={COLORS.status.error} r="4">
            ...
            <circle cx="420" cy="350" fill="none" opacity="0" r="12" stroke={COLORS.status.error} strokeWidth="1">
            ...
            <circle cx="320" cy="600" fill={COLORS.status.warning} r="4">
            ...
            <circle cx="320" cy="600" fill="none" opacity="0" r="12" stroke={COLORS.status.warning} strokeWidth="1">
            ...
            {/* Additional nodes */}
            <circle cx="480" cy="220" fill={COLORS.status.error} opacity="0.8" r="3">
              <animate attributeName="opacity" dur="3s" repeatCount="indefinite" values="0.8;0.2;0.8" />
            </circle>
            <circle cx="350" cy="150" fill={COLORS.status.warning} opacity="0.8" r="3">
      ...
      <div className="flex-1 h-full bg-layout-bg flex flex-col justify-between px-8 py-8 lg:px-20 overflow-y-auto" style={{ backgroundColor: COLORS.background.dark }}>
        {/* Header Branding */}
        ...
        <div className="w-full flex flex-col justify-center py-16">
          ...
          <button
            ...
            className="btn-primary w-full flex justify-center items-center gap-2 py-3 px-4 rounded-btn font-body-md text-body-md font-semibold transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary cursor-pointer"
            type="button"
          >
            <span>LOGIN</span>
          </button>
