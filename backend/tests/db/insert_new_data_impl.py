"""
PRISM — Insert New Data Implementation (20 Rows Per Table)
==========================================================
This is the actual implementation file. It is called by insert_new_data.py
and dynamically reloaded on each request to ensure live code updates run.
"""
...
def run_insert(request: Request, zcql):
    ...
    for table_name, queries in tables_queries.items():
        ...
        print(f"[insert-new-data-impl] {table_name}: {inserted_count}/{len(queries)}")
